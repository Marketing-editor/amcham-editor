 ...
 * - Pretty UI without Tailwind dependency
 * - Edit full email fields
 * - Manage timetable blocks (Header / Row / Session)
 * - Manage speakers
 * - Live preview
 * - Inline editing inside preview for major text areas
 * - Reset returns to the exact provided baseline HTML state
 */

const uid = () => Math.random().toString(36).slice(2, 10);
const STORAGE_KEY = "amcham_full_email_editor_pretty_v1";
...
const styles = {
  ...
  layout: {
    display: "grid",
    gridTemplateColumns: "320px 380px minmax(1100px, 1fr)",
    gap: 18,
    alignItems: "start",
  },
  card: {
        ...
        <div style={styles.topBar}>
          <div>
            ...
            <div style={styles.headerSub}>
              Edit event info, manage timetable blocks, and update text directly in the preview.
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                      ...
                      <Button danger onClick={() => deleteBlock(b.id)} title="Delete section">
                        Delete
                      </Button>
                    </div>
                  </div>
                    ...
                    <Segmented
                      ...
                      onChange={(t) => {
                        ...
                        if (t === "header") {
                          updateBlock({
                            type: "header",
                            title: selectedBlock.title || selectedBlock.label || "New Header",
                          });
                        } else if (t === "simple") {
                          updateBlock({
                            type: "simple",
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                          <label style={{ fontSize: 14 }}>
                            <input
                              ...
                              onChange={(e) => updateBlock({ bold: e.target.checked })}
                              style={{ marginRight: 8 }}
                            />
                            Bold
                          </label>
                          <label style={{ fontSize: 14 }}>
                            <input
                              ...
                              onChange={(e) => updateBlock({ highlight: e.target.checked })}
                              style={{ marginRight: 8 }}
                            />
                            Highlight
                          </label>
                          <label style={{ fontSize: 14 }}>
                            <input
                              ...
                              onChange={(e) => updateBlock({ centerLabel: e.target.checked })}
                              style={{ marginRight: 8 }}
                            />
                            Center label
                          </label>
                      ...
                      {(selectedBlock.speakers || []).map((sp, idx) => (
                        ...
                        >
                          ...
                          >
                            <div>
                              ...
                              <div style={{ fontSize: 12, color: "#64748b" }}>
                                {sp.title || ""} {sp.title && sp.org ? "·" : ""} {sp.org || ""}
                              </div>
                              {sp.tag ? (
                            ...
                            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                              ...
                              <GhostButton
                                disabled={idx === (selectedBlock.speakers || []).length - 1}
                                onClick={() => moveSpeaker(sp.id, "down")}
                              >
                                ↓
                              </GhostButton>
                              <Button danger onClick={() => deleteSpeaker(sp.id)}>
                                Delete
                              </Button>
                            </div>
                          </div>
                          ...
                          <Field label="Tag (optional: Moderator)">
                            <Input
                              value={sp.tag || ""}
                              onChange={(e) => updateSpeaker(sp.id, { tag: e.target.value })}
                            />
                          </Field>
                          ...
                          <Field label="Organization">
                            <Input
                              value={sp.org || ""}
                              onChange={(e) => updateSpeaker(sp.id, { org: e.target.value })}
                            />
                          </Field>
                          ...
                          <Field label="Photo URL">
                            <Input
                              value={sp.photoUrl || ""}
                              onChange={(e) => updateSpeaker(sp.id, { photoUrl: e.target.value })}
                            />
                          </Field>
